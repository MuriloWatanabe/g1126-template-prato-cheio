...
> **Acreditamos que** o que faz uma sobra boa do fim do expediente virar lixo em vez de doação é o **atrito de cadastro** — o esforço de publicar no pior horário do dia — e **não** a falta de vontade de doar.
>
> **Saberemos que estávamos errados se**, ao pedir a 5 doadores reais que publiquem ao vivo, no horário de fechamento, uma sobra daquele dia, o número que aponta o esforço/tempo do formulário como motivo de não fazer isso todo dia **for até 2 dos 5**.
>
> **Como medimos:** conversa de ~20 min com cada doador (restaurante, padaria ou mercado), presencial ou por telefone, no horário de fechamento. Entregamos o formulário dos três campos (descrição, quantidade, validade — RN-01), cronometramos o preenchimento de uma doação real e fazemos duas perguntas fechadas: *"Faria isso todo fim de expediente?"* e *"O que te faria parar?"*. Registramos, para cada doador: (a) completou ou desistiu, (b) tempo em segundos, (c) se citou espontaneamente o esforço do cadastro como impeditivo. O contador que decide é o (c). Cinco doadores × 20 min, sem software, custo zero, roda em duas semanas.

**Por que é hipótese e não crença:** existe um resultado que nos faz mudar de ideia — se 3 ou mais dos 5 preencherem sem reclamar do esforço e disserem que fariam todo dia, o atrito não é a barreira principal e a aposta no "itens frequentes" deixa de ser a prioridade certa.

## Decisão de análise

- **Problema:** o doador diz que para de publicar se o cadastro for longo ("paro de publicar e jogo a comida fora"); a vigilância sanitária exige três campos rastreáveis (o quê, quanto, validade) sob restrição legal. Mais campos = mais rastreabilidade e, na mesma medida, mais atrito e mais doação de última hora que não acontece — derrubando os objetivos 2 (aproveitamento) e 3 (rede ativa).

- **Alternativas:** (a) **poucos campos** — cortar obrigatórios para reduzir atrito, sacrificando rastreabilidade e o apoio do poder público condicionado à conformidade; (b) **muitos campos** — manter tudo obrigatório, protegendo a fiscalização e assumindo abandono na publicação; (c) **anular o eixo** — manter os três obrigatórios da RN-01, mas atacar o *custo por publicação* com "meus itens frequentes" (cadastro único do item recorrente; publicação diária vira selecionar item + confirmar quantidade + confirmar validade pré-preenchida) e onboarding assistido no primeiro cadastro.

- **Decisão e justificativa:** escolhida a alternativa (c). Segurança alimentar é restrição legal, não preferência negociável, então (a) está fora. Entre (b) e (c), vale o critério de mínimo necessário — *um campo só é obrigatório se, sem ele, a doação for irreconstituível em incidente sanitário* —, o que sustenta exatamente os três campos e nada além. (c) mantém a rastreabilidade intacta e derruba o atrito recorrente para poucos toques, atendendo os dois lados sem ceder no que é lei.

- **Riscos e limitações:** o eixo não some na **primeira** publicação de cada doador, que ainda paga o formulário completo — se o piloto mostrar abandono concentrado no primeiro cadastro, a decisão volta à mesa e, pelo critério acima, será resolvida a favor da vigilância, com o atrito atacado por onboarding assistido, não por remoção de campo. Além disso, a decisão pressupõe que o atrito é de fato a barreira do doador — pressuposto que **só se sustenta se a hipótese acima for confirmada**; se ela for falsificada (≤ 2 de 5 apontando o atrito), otimizar o formulário foi esforço desperdiçado e o impeditivo real (desconhecimento, desconfiança sanitária ou o horário em si) precisa do próprio experimento.
